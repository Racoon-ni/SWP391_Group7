                ...
                if (user != null && (user.getRole().equalsIgnoreCase("Admin") || user.getRole().equalsIgnoreCase("Staff"))) {
                    ...
                    if (view == null || view.isEmpty() || view.equalsIgnoreCase("list")) {
                        ...
                        if (id != null && !id.isEmpty()) {
                            ...
                            ArrayList<ProductAttribute> pAttList = pa.getAttributes(cateId);
                            Map<String, List<String>> attrValueOptions = pa.getAttrValueOptions(cateId);
                        ...
                        Map<String, List<String>> attrValueOptions = pa.getAttrValueOptions(comp.getCategory().getCategoryId());
                        ...
                        request.getRequestDispatcher("/WEB-INF/include/admin-comp-details.jsp").forward(request, response);
                        return;
            ...
            switch (act) {
                case "create": // not validate yet
                    ...
                    if (!errors.isEmpty()) {
                        ...
                        int productId = comp.addComponent(new Component(0, name, description, price, stock, imageFileName, category, true));
                        ...
                        if (productId != -1) {
                            ...
                            request.setAttribute("error", "Add Component failed");
                ...
                case "edit":
                    ...
                    category = c.getCategoryById(cateId);
                    if (category == null) {
                        errors.add("Invalid category ID.");
                    }
                    ...
                    // --- FINAL UPDATE ---
                    Component updatedComponent = new Component(id, name, description, price, stock, imageFileName, category, status);
                    if (comp.updateComponent(updatedComponent) == 1) {
                        response.sendRedirect(request.getContextPath() + "/manage-component");
                    }
