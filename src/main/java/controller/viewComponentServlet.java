...
public class ViewComponentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Thay List<Category> bằng List<Product>
        ...
        request.setAttribute("componentList", productList); // Đổi tên attribute nếu cần
    ...
    public String getServletInfo() {
        return "Hiển thị danh sách danh mục con theo parent_id.";
    }
}
