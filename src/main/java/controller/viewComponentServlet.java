...
public class viewComponentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            List<Product> componentList = new ProductDAO().getAllComponents();
            ...
            e.printStackTrace();
            response.getWriter().println("Lỗi khi lấy dữ liệu: " + e.getMessage());
        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        doGet(request, response); // Gọi lại GET để xử lý chung logic
    }
