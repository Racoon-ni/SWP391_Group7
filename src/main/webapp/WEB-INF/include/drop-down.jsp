...
<div class="panel">
    <label><input type="checkbox" name="type" value="discounted-inventory"> Hàng thanh lý</label><br>
    <label><input type="checkbox" name="type" value="normal-inventory"> Hàng thông thường</label>
</div>
