...
<head>
    ...
    <style>
        ...
        .checkout-container { max-width: 1100px; margin: 30px auto; background: #fff; padding: 30px; border-radius: 10px; }
        .section-title { font-size: 24px; font-weight: bold; }
        .total-box { border: 1px solid #ccc; padding: 20px; border-radius: 8px; background: #f1f1f1; }
        .qr-box { border: 1px dashed #0d6efd; background: #f8fbff; border-radius: 10px; padding: 16px; }
        .qr-img { width: 180px; height: 180px; object-fit: contain; background: #fff; border: 1px solid #e5e5e5; border-radius: 8px; }
        .copy-btn { white-space: nowrap; }
        .info-row { display: grid; grid-template-columns: 140px 1fr auto; gap: 8px; align-items: center; margin-bottom: 10px; }
        .info-row label { font-weight: 600; color: #495057; }
    </style>
</head>
<body>
...
<script>
    ...
    function confirmOrder() {
        ...
        }).then((r) => { if (r.isConfirmed) document.getElementById("orderForm").submit(); });
    }
    ...
    document.getElementById('pmCARD')?.addEventListener('change', toggleQR);
</script>
