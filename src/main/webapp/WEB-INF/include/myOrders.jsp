    ...
    <table class="table table-bordered text-center align-middle shadow-sm bg-white rounded">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="order-details?order_id=<%= order.getOrderId() %>" class="btn btn-outline-primary btn-action btn-sm">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="cancelOrderModalLabel"><i class="fas fa-times-circle"></i> Xác nhận hủy đơn</h5>
