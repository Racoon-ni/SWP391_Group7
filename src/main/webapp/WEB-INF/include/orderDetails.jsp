                        ...
                        <tbody>
                            <c:forEach var="item" items="${orderDetails}">
                                <tr>
                                    ...
                                    <td>${item.quantity}</td>
                                    <td>
                                        <fmt:formatNumber value="${item.unitPrice}" type="number" pattern="#,##0"/> VND
                                    </td>
                                    <td>
                                        <fmt:formatNumber value="${item.unitPrice * item.quantity}" type="number" pattern="#,##0"/> VND
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="mb-0">
                    ...
                    <span class="text-primary">
                        <fmt:formatNumber value="${order.totalPrice}" type="number" pattern="#,##0"/> VND
                    </span>
                </h5>
            </div>
