        ...
        <div class="container-fluid">
            ...
            <div class="d-flex gap-5">
                <c:if test="${not empty user}">
                    <div class="dropdown">
                        <a class="nav-link" href="${pageContext.request.contextPath}/profile" data-bs-toggle="dropdown">
                            Chào, ${user.username} <i class="fa-regular fa-circle-user" style="font-size: large"></i>
                        </a>
