<%-- 
    File: pc-best-seller.jsp
    Created on : Jun 17, 2025
    Author     : Huynh Trong Nguyen - CE190356
--%>

<%@ page pageEncoding="UTF-8" %>
<div class="pc-bestseller my-3 p-3 container border rounded">
    <div class="d-flex justify-content-between align-items-start mb-3">
        <h3 class="ms-2">PC bán chạy</h3>
        <a href="pc-list" class="me-2">Xem tất cả</a>
    </div>
    ...
    <div class="d-flex overflow-auto">
        ...
        <div class="column" style="width: 33%; margin: 0 -11px 0 31px">
            <div class="card shadow-sm">
                <img src="${pageContext.request.contextPath}/assets/images/product.webp" alt="PC Image" class="card-img-top">
