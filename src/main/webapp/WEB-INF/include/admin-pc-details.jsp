        ...
        <div class="admin-header">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="mb-0 opacity-75">Thông số PC</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7">
                    <div class="admin-card p-4">
                        <!-- Product Name -->
                        <div class="mb-4">
                            <h2 class="text-primary mb-2">${pc.name}</h2>
                            <p class="text-muted lead">${pc.description}</p>
                        </div>
